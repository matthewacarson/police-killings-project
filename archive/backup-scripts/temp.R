# ######################################################################### #
# ----------------------------- 11/10 ------------------------------------- #
# This script is not being used. The code that I am using has been 
# transferred to police-killings.R This script is only for backup in case
# I later decide that I do need this code/ these plots.
# ######################################################################### #
...
# The plot below has already been added to the other script (11/10)
